...
class DecryptionDialog(Tkinter.Frame):
    ...
    def decrypt(self):
        ...
        indir = inpath.split("\\")[:-1]
        indir = "\\".join(indir)
        outdir = os.path.join(os.getcwd(), "output").decode("gbk")
        errordir = os.path.join(os.getcwd(), "error").decode("gbk")
        ...
        for filename in self.infiles:
            ...
            errorpath = os.path.join(errordir, filename)
            ...
            try:
                ...
                try:
                    shutil.copyfile(inpath, errorpath)
                except:
                    pass
                #return
